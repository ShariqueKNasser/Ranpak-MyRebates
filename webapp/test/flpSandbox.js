		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Rebates",
									"targetURL": "#ranpakwzrebatelist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ranpakwzrebatelist-display": {
								"semanticObject": "ranpakwzrebatelist",
								"action": "display",
								"description": "My Rebates Fiori Application",
								"title": "My Rebates",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ranpak.wz.rebatelist",
									"url": sap.ui.require.toUrl("ranpak/wz/rebatelist")
								}
							}
						}
					}
